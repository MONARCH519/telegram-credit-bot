...
# 🔐 Токен Telegram-бота
TOKEN = "7645634931:AAHwrMbxLFuipIJFUMeiDY6OIEOiFTHlfb8"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "информация":
        await update.message.reply_text(
            ...
            "📄 2. Наши условия как связных кредиторов:\n"
    ...
    elif text == "связь с кредитором":
        keyboard = [
            [InlineKeyboardButton("💬 Написать кредитору", url="https://t.me/creditkorea993")]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
        await update.message.reply_text(
            "📞 Если вас всё устраивает, вы можете сразу связаться с кредитором по кнопке ниже:",
            reply_markup=reply_markup
        )
